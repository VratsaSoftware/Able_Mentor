...
@section('content')
    <form action="{{ route('students-store') }}" method="post" class="wpcf7-form">
        ...
        <div class="column one">
            ...
            <p><label>
                <span class="wpcf7-form-control-wrap students3"><input type="text" name="favorite_subjects" size="40"
                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                        aria-required="true" aria-invalid="false"/>
                </span>
            </label>
            ...
            <p>
                <label>
                    <span class="wpcf7-form-control-wrap students4">
                        <input type="text" name="hobbies" value="" size="40"
                            class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                            aria-required="true" aria-invalid="false"/>
                    </span>
                </label>
        ...
        <div class="column one">
            ...
            <p>
                <span class="wpcf7-form-control-wrap menu-english_students">
                    <select name="sport_id" class="wpcf7-form-control wpcf7-select" aria-invalid="false">
                        <option value="">---</option>
        ...
        <div class="column one">
            <h6 style="color:#4a4a4a;">В кои сфери имаш силен интерес да се развиваш и в кои по-слаб?
            </h6>
            <p>
