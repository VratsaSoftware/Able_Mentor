                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name_second" type="text" class="form-control @error('name_second') is-invalid @enderror" name="name_second" value="{{ old('name_second') }}" required autocomplete="name_second" autofocus>
