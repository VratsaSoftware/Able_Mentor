            ...
            <table class="table datatable table-striped table-bordered nowrap" style="border:1px; width: 100%">
                <thead>
                    <tr>
                        ...
                        <th>Образование – специалност (посочете всички специалности, ако имате повече от една)?</th>
                        <th>Име на учебното заведение, от където е придобита последната образователна степен:</th>
                        <th>Сфери, в които работите и/или сте работили досега (професионален опит):</th>
                        <th>Къде работите в момента (организация/компания)?</th>
