...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'school'                   => 'Училище',
        'class_id'                 => 'Клас',
        'favorite_subjects'        => 'Любими предмети',
        'hobbies'                  => 'Интереси',
        'english_level_id'         => 'Ниво на английски език',
        'sport_id'                 => 'Спорт',
        'after_school_plans'       => 'Какво ще правя след гимназията?',
        'strong_weak_sides'        => 'В кои сфери имаш силен интерес?',
        'qualities_to_change'      => 'Кои свои качества искаш да промениш/подобриш?',
        'free_time_activities'     => 'Как се забавляваш в свободното си време?',
        'difficult_situations'     => 'Разкажи ни за трудна ситуация/проблем и как си се справил/а?',
